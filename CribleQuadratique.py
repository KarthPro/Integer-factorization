...
def Seuil_Friabilite(n):
    B=int((np.exp((1/2)*large_sqrt(np.log2(n)*np.log2(np.log2(n)))[0])))
    return B
...
def Crible_Quadratique(n,B,Intervalle,count):
    ...
    print("Factorisation de {}".format(n))
    print("")
    ...
    print("")
    print("Racine de n : "+str(large_sqrt(n)))
...
print(str(CribleQuadratique_Chrono(n,B,Intervalle)))
